IF  EXISTS (
	SELECT 1
	FROM SYSOBJECTS
	WHERE NAME = 'p_rpt_ventas_gastos_sucursal'

)
DROP PROC p_rpt_ventas_gastos_sucursal
GO
-- p_rpt_ventas_gastos_sucursal 2,'20220801','20220830'
CREATE PROC p_rpt_ventas_gastos_sucursal
@pSucursalId INT,
@pDel DATETIME,
@pAl DATETIME
