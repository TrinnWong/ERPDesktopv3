...
namespace ERP.Reports
{
    ...
    public partial class rptExistenciasTicket : GrapeCity.ActiveReports.SectionReport
    {
        
        public rptExistenciasTicket(bool verLinea,bool verFamilia,bool verSubfamilia,bool verProductos)
        {
            //
        ...
        private void pageHeader_Format(object sender, EventArgs e)
        {
            ...
            uiFecha.Text = DateTime.Now.ToString("dd/MM/yyyy");
        }
    }
}
