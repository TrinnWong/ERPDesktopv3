...
namespace ERP.Reports
{
    ...
    /// </summary>
    public partial class rptCorteCajaPrevio : GrapeCity.ActiveReports.SectionReport
    {
        public bool esAdmin{get;set;}
        ERPProdEntities oContext;
        public rptCorteCajaPrevio()
        {
            //
        ...
        private void groupHeader1_Format_1(object sender, EventArgs e)
        {
            int folio;
        ...
        private void groupFooter1_Format_1(object sender, EventArgs e)
        {
            cat_configuracion entity = oContext.cat_configuracion.FirstOrDefault();
