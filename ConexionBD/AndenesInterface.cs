...
{
    public class AndenesInterface
    {
        Business con;
        Resultado resultado;

        public AndenesInterface()
        {
            con = new Business();
        }
        ...
        public DataTable ConsultarListado(string busqueda)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Andenes], case when Estatus = 1 then 'Activo' else 'Inactivo' end as [Estatus] from cat_andenes ";
                int clave = 0;
        ...
        public DataTable ConsultarRegistro(int clave, bool verificarNoExistaClave)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Andenes], Descripcion, case when Estatus = 1 then 'Activo' else 'Inactivo' end as [EstatusLetra], Estatus "
                                + "from cat_andenes "
        ...
        public Resultado Agregar(int clave, string descripcion, bool estatus, int? empresa, int? sucursal)
        {
            ...
            try
            {
                comandoInsert = "insert into cat_andenes "
        ...
        public Resultado Actualizar(int clave, string descripcion, bool estatus)
        {
            ...
            try
            {
                comandoUpdate = "update cat_andenes "
        ...
        public Resultado Eliminar(int clave)
        {
            ...
            try
            {
                comandoDelete = string.Format("delete from cat_andenes where Clave = {0}", clave);
        ...
        public DataTable ConsultaComboBox()
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion from cat_andenes where Estatus = 1";
                tabla = "Andanes";
