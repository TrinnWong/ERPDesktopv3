...
{
    public class EstatusEmpleadoInterface
    {
        Business con;
        Resultado resultado;

        public EstatusEmpleadoInterface()
        {
            con = new Business();
        }
        ...
        public DataTable ConsultarListado(string busqueda)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Estatus del Empleado], case when Estatus = 1 then 'Activo' else 'Inactivo' end as [Estatus] from rh_estatus_empleados ";
                int clave = 0;
        ...
        public Resultado Agregar(int clave, string descripcion, bool estatus, int? empresa, int? sucursal)
        {
            ...
            try
            {
                comandoInsert = "insert into rh_estatus_empleados "
        ...
        public Resultado Actualizar(int clave, string descripcion, bool estatus)
        {
            ...
            try
            {
                comandoUpdate = "update rh_estatus_empleados "
        ...
        public Resultado Eliminar(int clave)
        {
            ...
            try
            {
                comandoDelete = string.Format("delete from rh_estatus_empleados where Clave = {0}", clave);
        ...
        public DataTable ConsultaComboBox()
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion from rh_estatus_empleados where Estatus = 1";
                tabla = "EstatusEmpleado";
