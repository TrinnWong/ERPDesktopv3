...
{
    public class GruposSatInterface
    {
        Business con;
        Resultado resultado;

        public GruposSatInterface()
        {
            con = new Business();
        }
        ...
        public DataTable ConsultarListado(string busqueda)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Nombre Grupo],CodigoSAT as [Código SAT] from cat_grupos_sat ";
                int clave = 0;
        ...
        public DataTable ConsultarRegistro(int clave, bool verificarNoExistaClave)
        {
            ...
            try
            {
                comandoSelect = "select CodigoSAT,Clave, Descripcion, case when Estatus = 1 then 'Activo' else 'Inactivo' end as [EstatusLetra], Estatus "
                                + "from cat_grupos_sat "
        ...
        public Resultado Agregar(int clave, string descripcion, int? empresa, int? sucursal,string codigoSAT)
        {
            ...
            try
            {
                comandoInsert = "insert into cat_grupos_sat "
        ...
        public Resultado Actualizar(int clave, string descripcion,string codigoSAT)
        {
            ...
            try
            {
                comandoUpdate = "update cat_grupos_sat "
        ...
        public Resultado Eliminar(int clave)
        {
            ...
            try
            {
                comandoDelete = string.Format("delete from cat_grupos_sat where Clave = {0}", clave);
