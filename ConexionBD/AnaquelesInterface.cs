...
{
    public class AnaquelesInterface
    {
        Business con;
        Resultado resultado;

        public AnaquelesInterface()
        {
            con = new Business();
        }
        ...
        public DataTable ConsultarListado(string busqueda)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Nombre Anaquel], case when Estatus = 1 then 'Activo' else 'Inactivo' end as [Estatus] from cat_anaqueles ";
                int clave = 0;
        ...
        public DataTable ConsultarRegistro(int clave, bool verificarNoExistaClave)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Nombre Anaquel], Descripcion, case when Estatus = 1 then 'Activo' else 'Inactivo' end as [EstatusLetra], Estatus "
                                + "from cat_anaqueles "
        ...
        public Resultado Agregar(int clave, string descripcion, bool estatus, int? empresa, int? sucursal)
        {
            ...
            try
            {
                comandoInsert = "insert into cat_anaqueles "
        ...
        public Resultado Actualizar(int clave, string descripcion, bool estatus)
        {
            ...
            try
            {
                comandoUpdate = "update cat_anaqueles "
        ...
        public Resultado Eliminar(int clave)
        {
            ...
            try
            {
                comandoDelete = string.Format("delete from cat_anaqueles where Clave = {0}", clave);
        ...
        public DataTable ConsultaComboBox()
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion from cat_anaqueles where Estatus = 1";
                tabla = "Anaqueles";
