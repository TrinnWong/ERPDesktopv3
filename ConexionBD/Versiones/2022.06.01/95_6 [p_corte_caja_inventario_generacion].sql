...
-- p_corte_caja_inventario_generacion 10,'20221020','20221020'
...
as
	...
	INSERT INTO #TMP_RESULTADO(TipoMovimiento,Concepto,Abono,Cantidad,PrecioUnitario,Monto)
	SELECT '1.4.2-SOBRANTES PRODUCTO MOSTRADOR',P.Clave +'-'+ P.Descripcion,1,ISNULL(PSR.CantidadSobrante,0) - ISNULL(PSR.CantidadInventario,0),
			PP.Precio, 
