...
{
    public class LineasInterface
    {
        Business con;
        Resultado resultado;

        public LineasInterface()
        {
            con = new Business();
        }
        ...
        public DataTable ConsultarListado(string busqueda)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Lineas], case when Estatus = 1 then 'Activo' else 'Inactivo' end as [Estatus] from cat_lineas ";
                int clave = 0;
        ...
        public DataTable ConsultarRegistro(int clave, bool verificarNoExistaClave)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion, Descripcion, case when Estatus = 1 then 'Activo' else 'Inactivo' end as [EstatusLetra], Estatus "
                                + "from cat_lineas "
        ...
        public Resultado Agregar(int clave, string descripcion, bool estatus, int? empresa, int? sucursal)
        {
            ...
            try
            {
                comandoInsert = "insert into cat_lineas "
        ...
        public Resultado Actualizar(int clave, string descripcion, bool estatus)
        {
            ...
            try
            {
                comandoUpdate = "update cat_lineas "
        ...
        public Resultado Eliminar(int clave)
        {
            ...
            try
            {
                comandoDelete = string.Format("delete from cat_lineas where Clave = {0}", clave);
        ...
        public DataTable ConsultaComboBox()
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion from cat_lineas where Estatus = 1";
                tabla = "Lineas";
