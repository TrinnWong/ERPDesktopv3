...
{
    public class GirosNegocioInterface
    {
        Business con;
        Resultado resultado;

        public GirosNegocioInterface()
        {
            con = new Business();
        }
        ...
        public DataTable ConsultarListado(string busqueda)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Nombre Giro Negocio], case when Estatus = 1 then 'Activo' else 'Inactivo' end as [Estatus] from cat_giros_neg ";
                int clave = 0;
        ...
        public Resultado Agregar(int clave, string descripcion, bool estatus, int? empresa, int? sucursal)
        {
            ...
            try
            {
                comandoInsert = "insert into cat_giros_neg "
        ...
        public Resultado Actualizar(int clave, string descripcion, bool estatus)
        {
            ...
            try
            {
                comandoUpdate = "update cat_giros_neg "
        ...
        public Resultado Eliminar(int clave)
        {
            ...
            try
            {
                comandoDelete = string.Format("delete from cat_giros_neg where Clave = {0}", clave);
        ...
        public DataTable ConsultaComboBox()
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion from cat_giros_neg where Estatus = 1";
                tabla = "GiroNegocio";
