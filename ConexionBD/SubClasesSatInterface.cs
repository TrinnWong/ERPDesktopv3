...
{
    public class SubClasesSatInterface
    {
        Business con;
        Resultado resultado;

        public SubClasesSatInterface()
        {
            con = new Business();
        }
        ...
        public DataTable ConsultarListado(string busqueda)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Nombre SubClase],CodigoSAT as [Código SAT] from cat_subclases_sat  ";
                int clave = 0;
        ...
        public DataTable ConsultarRegistro(int clave, bool verificarNoExistaClave)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion as [Nombre SubClase],CodigoSAT "
                                + "from cat_subclases_sat "
        ...
        public Resultado Agregar(int clave, string descripcion, int? empresa, int? sucursal,string codigoSAT)
        {
            resultado = new Resultado();
            ...
            try
            {
                comandoInsert = "insert into cat_subclases_sat "
                                + "(Clave, Descripcion, Empresa, Sucursal,CodigoSAT) "
                                + "values(" + clave + ", '" + descripcion + "', " + strEmpresa + ", " + strSucursal +",'" + codigoSAT+  "')";
        ...
        public Resultado Actualizar(int clave, string descripcion,string codigoSAT)
        {
            resultado = new Resultado();
            string comandoUpdate = "";
            try
            {
                comandoUpdate = "update cat_subclases_sat "
                                + "set Descripcion = '" + descripcion + "',CodigoSAT='"+codigoSAT + "'"
                                + " where Clave = " + clave;
        ...
        public Resultado Eliminar(int clave)
        {
            ...
            try
            {
                comandoDelete = string.Format("delete from cat_subclases_sat where Clave = {0}", clave);
        ...
        public DataTable ConsultaComboBox()
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion from cat_subclases_sat where Estatus = 1";
                tabla = "SubClasesSat";
