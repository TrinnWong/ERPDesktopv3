...
{
    public class EstatusProductoInterface
    {
        Business con;
        Resultado resultado;

        public EstatusProductoInterface()
        {
            con = new Business();
        }
        ...
        public DataTable ConsultarListado(string busqueda)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion [Estatus Producto], case when Estatus = 1 then 'Activo' else 'Inactivo' end [Estatus] from cat_est_productos ";
                int clave = 0;
        ...
        public DataTable ConsultarRegistro(int clave, bool verificarNoExistaClave)
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion [Estatus Producto], case when Estatus = 1 then 'Activo' else 'Inactivo' end [EstatusLetra], Estatus "
                                + "from cat_est_productos "
        ...
        public Resultado Agregar(int clave, string descripcion, bool estatus, int? empresa, int? sucursal)
        {
            ...
            try
            {
                comandoInsert = "insert into cat_est_productos "
        ...
        public Resultado Actualizar(int clave, string descripcion, bool estatus)
        {
            ...
            try
            {
                comandoUpdate = "update cat_est_productos "
                                + "set Descripcion = '" + descripcion + "', Estatus = " + (estatus == true ? 1 : 0) + " "
                                + "where Clave = " + clave;
        ...
        public Resultado Eliminar(int clave)
        {
            ...
            try
            {
                comandoDelete = string.Format("delete from cat_est_productos where Clave = {0}", clave);
        ...
        public DataTable ConsultaComboBox()
        {
            ...
            try
            {
                comandoSelect = "select Clave, Descripcion from cat_est_productos where Estatus = 1";
                tabla = "EstatusProducto";
