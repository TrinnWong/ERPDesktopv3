...
BEGIN
	...
	begin
		...
		select @productoId,@pSucursalId,isnull(@pExistencias,0),@pCostoPromedio,
		@pCostoPromedio,0,0,getdate(),
		getdate(),			@pCostoPromedio		
		...
		begin
				...
				@pCostoPromedio,@pCostoPromedio,			getdate(),		@pCreadoPor
		...
		select @movimientoDetalle,	@movimiento,	@productoId,	1,
			...
			@pCreadoPor,			GETDATE(),		@pCostoPromedio,			@pCostoPromedio,
			@pCostoPromedio * @pExistencias,@pCostoPromedio * @pExistencias,				@pCostoPromedio * @pExistencias
