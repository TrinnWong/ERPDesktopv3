...
as
	...
	begin
		...
		insert into [dbo].[doc_pedidos_orden](
			...
			Activo,CreadoEl,CreadoPor,Personas,FechaApertura,FechaCierre,UberEats,Para,Notas
		)
		select @pPedidoId,@pSucursalId,@pComandaId,@pPorcDescuento,@pSubtotal,@pDescuento,@pImpuestos,@pTotal,@pClienteId,@pMotivoCancelacion,
			1,getdate(),@pCreadoPor,@pPersonas,@pFechaApertura,@pFechaCierre,@pUberEats,@pPara,@pNotas
	end
	Else
	Begin
