...
as
	...
	set @valuadoCostoUCompra = CASE WHEN  @esMatriz = 1 THEN  
	...
	set @valuadoCostoPromedio = CASE WHEN @esMatriz = 1 THEN 
	...
	update doc_inv_movimiento_detalle
		set Disponible = ISNULL(@existencia,0),
			CostoPromedio = CASE WHEN @esMatriz = 1 then 
							...
							END,
			CostoUltimaCompra = CASE WHEN @esMatriz = 1 THEN
