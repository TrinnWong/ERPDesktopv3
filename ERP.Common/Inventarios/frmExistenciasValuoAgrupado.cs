...
{
    public partial class frmExistenciasValuoAgrupado : FormERP
    {
        public static frmExistenciasValuoAgrupado GetInstance()
        {
            if (_instance == null) _instance = new frmExistenciasValuoAgrupado();
            return _instance;
        }
        private static frmExistenciasValuoAgrupado _instance;

        public frmExistenciasValuoAgrupado()
        {
            InitializeComponent();
        ...
        public void showReport(bool enviar)
        {
            ...
            oCorte.DataSource = oContext.p_rpt_productos_existencias(sucursalId, linea, familia, subFamilia, uiSoloExistencia.Checked,null,null,null).ToList();
