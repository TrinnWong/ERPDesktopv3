...
{
    public partial class frmVentaFormasPago : Form
    {
        ...
        private void pagar()
        {
            ...
            if (error.Length == 0)
            {
                ...
                frmPuntoVentaRest.GetInstance().pagar(lstFormasPago, lstVales, uiTotalRecibido.Value, uiCambio.Value);
