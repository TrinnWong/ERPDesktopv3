...
ALTER TABLE [dbo].[doc_pedidos_orden_ingre]  WITH CHECK ADD  CONSTRAINT [FK_doc_pedidos_orden_ingre_cat_productos_base] FOREIGN KEY([ProductoMateriaPrimaId])
REFERENCES [dbo].[cat_productos_base] ([ProductoMateriaPrimaId])
