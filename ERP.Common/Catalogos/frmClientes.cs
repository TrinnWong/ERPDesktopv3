...
namespace ERP.Common
{
    ...
    {
        bool isLoad = false;
        ConexionBD.Clientes oData;
        ERPProdEntities oContext;
        public frmClientes()
        {
            InitializeComponent();

            oData = new ConexionBD.Clientes();
        ...
        public void configurarBotones(bool agregar, bool editar, bool eliminar)
        {
        ...
        private void LlenarCombos()
        {
            ...
            uiTipoCliente.DataSource = oContext.cat_tipos_cliente.ToList();
            uiTipoCliente.SelectedValue = 0;
        ...
        private void Buscar()
        {
            ...
            dgvGrid.DataSource = oData.oContext.cat_clientes.Where(
        ...
        //    if (uiClave.Value <= 0)
        //    {
        //        error =error + "\nLa clave debe de ser mayor a cero";
        //    }
        //    if (uiTelefono.Text.Trim() == "" &&
        //        uiTelefono2.Text.Trim() == "")
        //    {
        //        error = "\nEs necesario capturar por lo menos un teléfono";
        //    }
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cat_clientes entity = new cat_clientes();

                entity.ClienteId =oContext.cat_clientes.Count() > 0 ?
                    oContext.cat_clientes.Max(M=> M.ClienteId) + 1
                    :1;
                entity.Activo = true;
                ...
                entity.TipoClienteId = uiTipoCliente.SelectedValue != null ? (byte?)uiTipoCliente.SelectedValue : null;                
        ...
        private void Limpiar()
        {
            ...
            this.uiTipoCliente.SelectedValue = 0;
            uiListaPrecios.Enabled = false;
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                entity.ClienteId = (int)this.uiClave.Value;
        ...
        {
            oContext = new ERPProdEntities();
            cat_clientes entity = oData.oContext.cat_clientes
            ...
            this.uiClave.Value = entity.ClienteId;
            ...
            this.uiTipoCliente.SelectedValue = entity.TipoClienteId ?? 0;
        ...
        private void uiClienteEspecial_CheckedChanged(object sender, EventArgs e)
        {
            if (uiClienteEspecial.Checked)
            {
        ...
        private void uiClienteGral_CheckedChanged(object sender, EventArgs e)
        {
            if (uiClienteEspecial.Checked)
            {
                uiListaPrecios.Enabled = true;
