...
namespace ERP.Common.Utils
{
    public class RawPrinterHelper
    {
        ...
        public static string CortaTicket(string nombreImpresora)
        {
            string error = "";
            ...
            try
            {
                ...
                {
                    error = "No se ha configurado la impresora para la caja. Vaya a la sección de impresoras";
                    return error;
                }

                string corte = "\x1B" + "m";                                // caracteres de corte
                string avance = "\x1B" + "d" + "\x09";                      // avanza 9 renglones
                RawPrinterHelper.SendStringToPrinter(nombreImpresora, avance);        // avanza
                RawPrinterHelper.SendStringToPrinter(nombreImpresora, corte);
            }
            catch (Exception ex)
            {
                error = ex.Message;
        ...
        public static string AbreCajon(string nombreImpresora)
        {
            ...
            try
            {
                ...
                RawPrinterHelper.SendStringToPrinter(nombreImpresora, cajon0);        // abre cajon0
