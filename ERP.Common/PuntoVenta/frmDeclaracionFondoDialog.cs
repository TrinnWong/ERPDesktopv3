...
{
    public partial class frmDeclaracionFondoDialog : Form
    {
        public string error = "";
        ...
        public List<DeclaracionFondoModel> model1;
        public List<DeclaracionFondoModel> model2;

        DeclaracionFondoBusiness oDeclaracionB;
        public frmDeclaracionFondoDialog()
        {
            InitializeComponent();
